          ...
          <Col xs={12} sm={5} md={5}>
            ...
            >
              ...
              <div className="navPanel_1">
                <Waypoint
                  onEnter={() =>
                    this.handleAnimationTrigger("animationTriggerTwo")
                  }
                  bottomOffset="55%"
                />
                <NavPanel
                ...
                {this.state.fileRejected && (
                  <p>
                    <b>
                      Please upload an image file between 5kb and 4mb in size
                    </b>
                  </p>
                )}
              </div>
            ...
            <div className="navPanel_2">
              <Waypoint
                onEnter={() =>
                  this.handleAnimationTrigger("animationTriggerThree")
                }
                bottomOffset="55%"
              />
              <NavPanel
